...
// agentSandboxClientFactory builds an agent-sandbox client for the given
// (namespace, template). Tests override via SetAgentSandboxClientFactory.
// Duplicated across controller / controller2 because both Registries exist
// in parallel until the controller2 refactor lands.
